...
public class Filtros
{
	 ...
	 * Saldo de la cuenta
	 */
	@JsonProperty(value="elementosEscenario")
	private String elementosEscenario;
	 ...
	 */
	public Filtros(@JsonProperty(value="fechaInicio")Date fechaInicio,@JsonProperty(value="fechaFin") Date fechaFin, 
